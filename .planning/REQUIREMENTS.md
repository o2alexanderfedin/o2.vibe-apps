...
- [ ] **LOOP-05**: Generated JSX is compiled to JS exactly once, the compiled string is stored, and it is never recompiled from storage twice within a session (session-scoped in-memory transpiled cache)
